            ...
            if (!dojo.hasClass(featureNode, "has-neat-introns")) {
                ...
                if (subNodes.length < 2) {
                    ...
                    if (
                        ...
                        subFeatureIntron[0].className.indexOf("annot-apollo") <
                            0 &&
                        subFeatureIntron[0].className.indexOf("annot-render") <
                            0
                    ) {
                    ...
                    for (var i = 0; i < subNodes.length - 1; ++i) {
                        var gap =
                            subNodes[i + 1].left -
                            (subNodes[i].left + subNodes[i].width);
                        if (gap > 0.02) {
