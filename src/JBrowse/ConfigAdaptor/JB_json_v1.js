            ...
            load: function (/**Object*/ args) {
                ...
                if (args.config.url) {
                    ...
                    return Util.resolved(
                        this.regularize_conf(args.config.data, args),
                    );
                }
            },
                    ...
                    function (trackConfig) {
                        ...
                        if (trackConfig.histograms) {
                            if (!trackConfig.histograms.baseUrl)
                                trackConfig.histograms.baseUrl =
                                    trackConfig.baseUrl;
                            this._synthesizeTrackStoreConfig(
                                conf,
                                trackConfig.histograms,
                            );
                        }
                    },
                    this,
