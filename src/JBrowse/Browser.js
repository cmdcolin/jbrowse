    ...
    return declare(FeatureFiltererMixin, {
            ...
            dojo.addOnLoad(function () {
                ...
                thisB.loadConfig().then(function () {
                    ...
                    if (
                        ...
                        thisB.setHighlight(
                            new Location(thisB.config.initialHighlight),
                        );
                    ...
                    thisB.initPlugins().then(function () {
                        ...
                        thisB.loadUserCSS().then(function () {
                            ...
                            thisB.loadRefSeqs().then(function () {
                                ...
                                var initialLoc =
                                    Util.parseLocString(initialLocString);
                                if (
                                    initialLoc &&
                                    initialLoc.ref &&
        ...
        _initialLocation: function () {
            ...
            if (this.config.location) {
                ...
                return (
                    oldLocMap[this.refSeq.name].l || oldLocMap[this.refSeq.name]
                );
        ...
        initPlugins: function () {
            return this._milestoneFunction("initPlugins", function (deferred) {
                ...
                plugins.forEach((p) => {
                    ...
                    let configEntry = dojoConfig.packages.find(
                        (c) => c.name === p.name,
                    );
                    if (configEntry) {
                        ...
                        array.forEach(
                            ...
                            function (pluginClass, i) {
                                ...
                                if (typeof pluginClass == "string") {
                                    ...
                                    this.plugins[plugin.name] = new pluginClass(
                                        args,
                                    );
                                }
                            },
        ...
        resolveUrl: function (url) {
            var browserRoot =
                this.config.browserRoot || this.config.baseUrl || "";
        ...
        welcomeScreen: function (container, error) {
            ...
            require(["dojo/text!JBrowse/View/Resource/Welcome.html"], function (
                ...
                request(
                    thisB.resolveUrl(
                        "sample_data/json/volvox/successfully_run",
                    ),
                ).then(function () {
                    try {
                        document.getElementById(
                            "volvox_data_placeholder",
                        ).innerHTML =
        ...
        loadRefSeqs: function () {
            ...
            return this._milestoneFunction("loadRefSeqs", function (deferred) {
                ...
                if (this.config.refSeqs.storeClass) {
                    dojo.global.require(
                        [this.config.refSeqs.storeClass],
                        (CLASS) => {
                            const r = new CLASS(
                                Object.assign(
                                    { browser: this },
                    ...
                    if (
                        ...
                        request(this.resolveUrl(this.config.refSeqs.url), {
                            ...
                            function (e) {
                                deferred.reject(
                                    "Could not load reference sequence definitions. " +
                                        e,
                                );
                            },
                        );
            ...
            return this._milestoneFunction("loadNames", function (deferred) {
                ...
                if ((type = conf.type)) {
                    ...
                    dojo.global.require([type], function (CLASS) {
                        thisB.nameStore = new CLASS(
                            dojo.mixin({ browser: thisB }, conf),
                        );
                        deferred.resolve({ success: true });
                    });
                }
        ...
        regularizeLocation: function (location) {
            var ref = this.findReferenceSequence(
                location.ref || location.objectName,
            );
        ...
        initView: function () {
            ...
            return this._milestoneFunction("initView", function (deferred) {
                    ...
                    this.addGlobalMenuItem(
                        ...
                        new dijitMenuItem({
                            ...
                            onClick: function () {
                                new OpenDirectoryDialog({
                                    browser: thisObj,
                                    setCallback: dojo.hitch(
                                        thisObj,
                                        "openDirectoryElectron",
                                    ),
                                }).show();
                            },
                        }),
                    ...
                    this.addGlobalMenuItem(
                        ...
                        new dijitMenuItem({
                            ...
                            onClick: dojo.hitch(this, function () {
                                var container =
                                    thisObj.container || document.body;
                            ...
                            onClick: function () {
                                new SetTrackHeightDialog({
                                    setCallback: function (height) {
                                        var tracks =
                                            thisObj.view.visibleTracks();
                                        array.forEach(tracks, function (track) {
                                            // operate only on XYPlot or Density tracks
                                            if (
                                                !/\b(XYPlot|Density)/.test(
                                                    track.config.type,
                                                )
                                            )
                                                return;
                ...
                var contentWidget = new dijitContentPane(
                    { region: "top" },
                    topPane,
                );
        ...
        renderDatasetSelect: function (parent) {
            ...
            if (this.config.classicMenu) {
                ...
                for (var id in dsconfig) {
                    if (!/^_/.test(id))
                        datasetChoices.push(
                            Object.assign({ id: id }, dsconfig[id]),
                        );
                }
                ...
                const combobox = new dijitComboBox({
                    ...
                    onChange: (dsName) => {
                        ...
                        const dsID = datasetChoices.find(
                            (d) => d.name === dsName,
                        ).id;
                        ...
                        if (ds) {
                            let link2Parent =
                                conf.datasetLinkToParentIframe || false;
                ...
                if (this.config.datasetSelectorWidth) {
                    combobox.domNode.style.width =
                        this.config.datasetSelectorWidth;
                    combobox.focusNode.style.width =
                        this.config.datasetSelectorWidth;
                }
            } else {
                let conf = this.config;
                            ...
                            this.addGlobalMenuItem(
                                ...
                                new dijitMenuItem({
                                    ...
                                    onClick: dojo.hitch(dataset, function () {
                                        ...
                                        let link2Parent =
                                            conf.datasetLinkToParentIframe ||
                                            false;
                                        if (link2Parent)
                ...
                openCallback: dojo.hitch(this, function (results) {
                    ...
                    if (confs.length) {
                        ...
                        if (
                            ...
                            var fasta = Util.replacePath(
                                confs[0].store.bgzfa.url,
                            );
                            ...
                            var f2bit = Util.replacePath(
                                confs[0].store.blob.url,
                            );
                            trackList.tracks[0].storeClass =
                                "JBrowse/Store/SeqFeature/TwoBit";
                    ...
                    if (confs.length) {
                        ...
                        array.forEach(
                            ...
                            function (conf) {
                                ...
                                storeConf =
                                    conf.histograms && conf.histograms.store;
                                if (storeConf && typeof storeConf == "object") {
        ...
        _reportGoogleUsageStats: function (stats) {
            ...
            document
                ...
                .appendChild(analyticsScriptNode);
        },
                    ...
                    if (parsedDataRoot.host) {
                        ...
                        if (
                            ...
                            (parsedDataRoot.host !== currentParsed.host ||
                                parsedDataRoot.protocol !==
                                    currentParsed.protocol)
                        )
                            throw new Error(
                ...
                if (!this.config.refSeqOrder) {
                    ...
                    if (
                        ...
                        if (lang.isArray(this.config.refSeqOrderList)) {
                            ...
                            typeof this.config.refSeqOrderList === "string"
                        ) {
        ...
        onFineMove: function (startbp, endbp) {
            if (this.locationTrap) {
                ...
                var trapLeft = Math.round(
                    ((startbp - this.view.ref.start) / length) *
                        this.view.overviewBox.w +
                        this.view.overviewBox.l,
                );
                var trapRight = Math.round(
                    ((endbp - this.view.ref.start) / length) *
                        this.view.overviewBox.w +
                        this.view.overviewBox.l,
                );
        ...
        initTrackMetadata: function (callback) {
            var thisB = this;
            return this._milestoneFunction(
                "initTrackMetadata",
                function (deferred) {
                    ...
                    dojo.global.require(
                        ...
                        dojo.hitch(this, function (MetaDataStore) {
                            ...
                            this.trackMetaDataStore = new MetaDataStore(
                                dojo.mixin(
                                    dojo.clone(this.config.trackMetadata || {}),
                                    {
        ...
        navigateTo: function (loc, initial) {
            ...
            this.afterMilestone("initView", function () {
                ...
                var ret = thisB.searchNames(loc).then(function (found) {
                    ...
                    var location =
                        typeof loc == "string" ? Util.parseLocString(loc) : loc;
            ...
            this.afterMilestone(
                ...
                dojo.hitch(this, function () {
                    ...
                    var ref = location.ref
                        ? this.findReferenceSequence(
                              location.ref.name || location.ref,
                          )
                        : this.refSeq;
                    ...
                    if (
                        ...
                        try {
                            oldLoc = Util.parseLocString(
                                dojo.fromJson(this.cookie("location"))[
                                    location.ref
                                ].l,
                            );
                    ...
                    (nameMatches) => {
                        ...
                        if (!goingTo) {
                            for (i = 0; i < nameMatches.length; i++) {
                                if (
                                    nameMatches[i].name.toLowerCase() ==
                                    loc.toLowerCase()
                                )
                                    goingTo = nameMatches[i];
                            }
        ...
        makeFullViewLink: function () {
            ...
            var makeURL =
                this.config.makeFullViewURL || this.makeCurrentViewURL;
        ...
        _updateHighlightClearButton: function () {
            ...
            if (this.highlightButton) {
                this.highlightButton.set(
                    "checked",
                    isHighlightSet ? "mixed" : false,
                );
