    ...
    discardRange(left, right) {
        ...
        if (
            ...
            const rightTrimAmount =
                this.bits.length - 1 - (this.max - this.offset);
            ...
            // trim left side
            const desiredOffset =
                this.min - Math.floor(minSizeToBotherWith / 2);
...
define(["dojo/_base/declare"], (declare) =>
    declare(null, {
        ...
        constructor(args) {
            ...
            this.bitmap = [];
            this.rectangles = {};
            this.maxHeight = Math.ceil(
                (args.maxHeight || Infinity) / this.pitchY,
            );
