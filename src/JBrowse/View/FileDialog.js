    ...
    return declare(null, {
                ...
                onClick: dojo.hitch(this, function () {
                    openCallback &&
                        openCallback({
                            ...
                            trackDisposition: this.trackDispositionChoice[0]
                                .checked
        ...
        show: function (args) {
            ...
            dojo.connect(localFilesControl.uploader, "onChange", function () {
                if (Util.isElectron()) {
                    const arr = [...localFilesControl.uploader._files].map(
                        (file) => Util.replacePath(file.path),
                    );
                    resourceListControl.addURLs(arr);
                } else {
                    resourceListControl.addLocalFiles(
                        localFilesControl.uploader._files,
                    );
                }
            });
