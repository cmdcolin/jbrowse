    ...
    return declare([CanvasFeatureTrack, AlignmentsMixin], {
        ...
        _trackMenuOptions() {
            ...
            m.children.push({
                ...
                checked:
                    this.config.glyph == "JBrowse/View/FeatureGlyph/Alignment",
            ...
            m.children.push({
                ...
                checked:
                    this.config.glyph ==
                    "JBrowse/View/FeatureGlyph/PairedReadCloud",
                onClick: function (event) {
                    thisB.config.glyph =
                        "JBrowse/View/FeatureGlyph/PairedReadCloud";
                    thisB.browser.publish("/jbrowse/v1/v/tracks/replace", [
            ...
            m.children.push({
                ...
                onClick: function (event) {
                    ...
                    thisB.config._oldAlignmentsHeight =
                        thisB.config.style.height;
                    thisB.config.style.height =
                        thisB.config._oldSnpCoverageHeight;
                    thisB.browser.publish("/jbrowse/v1/v/tracks/replace", [
                        thisB.config,
                    ]);
                },
            ...
            c.children.push({
                ...
                onClick: function (event) {
                    thisB.clearColorConfig();
                    thisB.config.colorByOrientationAndSize =
                        this.get("checked");
                    thisB.browser.publish("/jbrowse/v1/v/tracks/replace", [
                        thisB.config,
                    ]);
                    ...
                    children: [
                        {
                            ...
                            onClick: function (event) {
                                thisB.config.readCloudLogScale =
                                    this.get("checked");
                        ...
                        },
                        {
                            ...
                            onClick: function (event) {
                                new Dialog({
                                    ...
                                    maxHeight: Infinity,
                                    height:
                                        thisB.config.readCloudYScaleMax ||
                                        50000,
                                    setCallback: (ret) => {
                    ...
                    children: [
                        {
                            ...
                            onClick: function (event) {
                                thisB.config.showInterchromosomalArcs =
                                    this.get("checked");
                                thisB.browser.publish(
                                    "/jbrowse/v1/v/tracks/replace",
                                    [thisB.config],
        ...
        fillFeatures(args) {
            ...
            if (
                ...
                if (
                    ...
                    min = Math.max(
                        0,
                        args.leftBase - this.config.maxInsertSize,
                    );
