                ...
                if (yPos <= canvasHeight) {
                    ...
                    if (yPos <= originY) {
                        ...
                        if (!disableClipMarkers && yPos >= canvasHeight) {
                            // draw clip marker if necessary
                            context.fillStyle =
                                clipColor || thisB.colorForBase(ID);
                            thisB._fillRectMod(
                                context,
                                fRect.l,
                                canvasHeight - 3,
            ...
            dojo.forEach(
                ...
                function (f, i) {
                    ...
                    score.forEach(function (count, category) {
                        if (
                            !{ reference: true, skip: true, deletion: true }[
                                category
                            ] &&
                            ...
                            snpContext.save();
                            if (
                                thisB.browser.config.highResolutionMode !=
                                "disabled"
                            )
        ...
        _showPixelValue: function (scoreDisplay, score) {
            ...
            if (score.snpsCounted) {
                ...
                score.forEach(function (count, category) {
                    ...
                    category =
                        { "*": "del", reference: "Ref", skip: "Skip/intron" }[
                            category
                        ] || category;
                    scoreSummary +=
                        "<tr><td>" +
