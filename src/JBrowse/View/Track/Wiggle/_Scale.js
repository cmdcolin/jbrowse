                    ...
                    : (function () {
                          switch (config.autoscale) {
                              case "z_score":
                                  return Math.max(
                                      -z_score_bound,
                                      (stats.scoreMin - stats.scoreMean) /
                                          stats.scoreStdDev,
                                  );
                              case "global":
                              case "local":
                              ...
                              default:
                                  return Math.max(
                                      stats.scoreMin,
                                      stats.scoreMean -
                                          z_score_bound * stats.scoreStdDev,
                                  );
                          }
                      })();
            var max =
                    ...
                    : (function () {
                          switch (config.autoscale) {
                              case "z_score":
                                  return Math.min(
                                      z_score_bound,
                                      (stats.scoreMax - stats.scoreMean) /
                                          stats.scoreStdDev,
                                  );
                              case "global":
                              case "local":
                ...
                switch (config.scale) {
                    case "z_score":
                        return function (value) {
                            return (
                                (value + this.offset - this.scoreMean) /
                                    this.scoreStdDev -
                                this.min / this.range
                            );
                        };
                    case "log":
                        return function (value) {
                            return (
                                (this.log(value + this.offset) - this.min) /
                                this.range
                            );
                        };
                    case "linear":
                    ...
                    default:
                        return function (value) {
                            return (
                                (value + this.offset - this.min) / this.range
                            );
                        };
                }
            })(config);
