define([
    ...
    return declare(null, {
        ...
        _canExport: function () {
            ...
            return (
                (highlightedRegion &&
                    this._canExportRegion(highlightedRegion)) ||
        ...
        _exportDialogContent: function () {
            ...
            var setFilenameValue = dojo.hitch(this.track, function () {
                ...
                var format =
                    nameToExtension[this._readRadio(form.elements.format)];
