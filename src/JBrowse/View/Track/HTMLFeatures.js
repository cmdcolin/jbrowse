    ...
    var HTMLFeatures = declare(
        ...
        ],
        {
            ...
            fillHistograms: function (args) {
                ...
                this.store.getRegionFeatureDensities(
                    ...
                    function (histData) {
                        ...
                        track.heightUpdate(
                            dims.pxPerCount *
                                (dims.logScale ? Math.log(maxBin) : maxBin),
                            blockIndex,
                        );
                ...
                for (
                    ...
                    for (var i = 0; i < childNodes.length; i++) {
                        ...
                        if (strand < 0 && fmax > viewmin) {
                            var minusArrowClass =
                                "minus-" + this.config.style.arrowheadClass;
                        ...
                        // plus strand
                            ...
                            var plusArrowClass =
                                "plus-" + this.config.style.arrowheadClass;
                            featDivChildren = featDiv.childNodes;
                            for (var j = 0; j < featDivChildren.length; j++) {
                                arrowhead = featDivChildren[j];
                                if (typeof arrowhead.className === "string") {
                                    if (
                                        ...
                                        arrowhead.style.right =
                                            (fmax > viewmax
                                                ? block.bpToX(displayEnd) -
                                                  block.bpToX(viewmax - 2)
            ...
            makeHistogramYScale: function (blockSizeBp, dims, histData) {
                if (dims.logScale) {
                    console.error(
                        "Log histogram scale axis labels not yet implemented.",
                    );
                    return;
                }
            ...
            transfer: function (
                ...
                for (var i = 0; i < overlaps.length; i++) {
                    ...
                    if (
                        sourceSlot &&
                        sourceSlot.label &&
                        sourceSlot.label.parentNode
                    ) {
                        sourceSlot.label.parentNode.removeChild(
                            sourceSlot.label,
                        );
                    }
            ...
            addFeatureToBlock: function (
                ...
                if (
                    (typeof this.browser.config.inferHTMLSubfeatures ===
                        "undefined" ||
                ...
                for (var i in blocks) {
                    if (blocks.hasOwnProperty(i)) {
                        ...
                        var makeDiv = function (
                            ...
                            coverageNode.style.left =
                                (100 * (start - s)) / (e - s) + "%";
                            coverageNode.style.top = "0px";
                            coverageNode.style.width =
                                (100 * (end - start)) / (e - s) + "%";
                            return coverageNode;
                        };
                        ...
                        var addDiv = function (
                            ...
                            for (var key in parentDiv.childNodes) {
                                if (
                                    ...
                                    var divStart =
                                        parentDiv.childNodes[key].span.s;
                                    var divEnd =
                                        parentDiv.childNodes[key].span.e;
                                    ...
                                    if (u) {
                                        ...
                                        var tempIndex =
                                            parentDiv.booleanCovs.indexOf(
                                                parentDiv.childNodes[key],
                                            );
                                        parentDiv.removeChild(
                                            parentDiv.childNodes[key],
                                        );
                                        parentDiv.booleanCovs.splice(
                                            tempIndex,
                                            1,
                                        );
                                        parentDiv.appendChild(coverageNode);
                                        parentDiv.booleanCovs.push(
                                            coverageNode,
                                        );
                                        isAdded = true;
                                        addDiv(
            ...
            renderFeature: function (
                ...
                if (
                    ...
                    description =
                        description
                            .substr(
                                0,
                                this.config.style.maxDescriptionLength + 1,
                            )
                            .replace(/(\s+\S+|\s*)$/, "") +
                ...
                if (this.showLabels && scale >= labelScale && name) {
                    layoutEnd = Math.max(
                        layoutEnd,
                        layoutStart +
                            (("" + name).length * this.labelWidth) / scale,
                    );
                ...
                if (this.showLabels && description) {
                    layoutEnd = Math.max(
                        layoutEnd,
                        layoutStart +
                            (("" + description).length * this.labelWidth) /
                                scale,
                    );
                    levelHeight += this.labelHeight + this.labelPad;
                }
                    ...
                    var labelDiv = dojo.create(
                        "div",
                        {
                            ...
                            style: {
                                ...
                                left:
                                    (100 * (layoutStart - block.startBase)) /
                                        blockWidth +
                                    "%",
                            },
                        },
            ...
            renderSubfeature: function (
                ...
                if (
                    truncate &&
                    (subEnd <= displayStart || subStart >= displayEnd)
                )
                    return null;
