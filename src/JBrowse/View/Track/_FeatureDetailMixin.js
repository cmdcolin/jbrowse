    ...
    return declare(FeatureDescriptionMixin, {
        ...
        _renderCoreDetails: function (track, f, featDiv, container) {
            ...
            coreDetails.innerHTML +=
                '<h2 class="sectiontitle">Primary Data</h2>';
        ...
        _renderSubfeaturesDetail: function (
            track,
            f,
            featDiv,
            container,
        ...
        _renderAdditionalTagsDetail: function (track, f, featDiv, container) {
            ...
            var additionalTags = array.filter(
                ...
                function (t) {
                    if (
                        thisB.config.showNoteInAttributes &&
                        t.toLowerCase() == "note"
                    ) {
                        return true;
                    }
