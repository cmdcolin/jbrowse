        ...
        ],
        {
            ...
            setViewInfo: function (
                ...
                this.staticCanvas.height =
                    this.staticCanvas.offsetHeight * ratio;
            ...
            guessGlyphType: function (feature) {
                ...
                if (!guess) {
                    ...
                    if (children && children.length) guess = "Segments";
                        ...
                        feature.get("block_count") ||
                        feature.get("thick_start")
                    )
                        guess = "UCSC/BED";
                    else guess = "Box";
                }
                    ...
                    dojo.global.require(
                        ...
                        function (GlyphClass) {
                            if (typeof GlyphClass == "string") {
                                thisB.fatalError =
                                    "could not load glyph " + glyphClassName;
                                thisB.redraw();
                                return;
                            }
            ...
            _drawHistograms: function (viewArgs, histData) {
                ...
                if (
                    !(
                        ...
                        (histData.bins &&
                            (features = this._histBinsToFeatures(
                                viewArgs,
                                histData,
                            )))
                    )
                ...
                for (var i = 0; i < features.length; i++) {
                    ...
                    var barLeft = Math.round(
                        (feature.get("start") - leftBase) * scale,
                    );
                    ctx.fillRect(
                        barLeft,
                        height - barHeight,
                    ...
                    if (barHeight > height) {
                        ctx.fillStyle =
                            this.config.histograms.clip_marker_color;
            ...
            renderClickMap: function (args, fRects) {
                ...
                if (
                    !block.featureCanvas ||
                    !block.featureCanvas.getContext("2d")
                ) {
                    ...
                    (function (event, handler) {
                        ...
                        block.own(
                            on(this.staticCanvas, event, function (evt) {
                                evt = domEvent.fix(evt);
                                var bpX = thisB.browser.view.absXtoBp(
                                    evt.clientX,
                                );
                                if (block.containsBp(bpX)) {
                                    ...
                                    if (feature) {
                                        var fRect = block.fRectIndex.getByID(
                                            feature.id(),
                                        );
                                        handler.call(
                                            {
                ...
                array.forEach(
                    ...
                    function (block, i) {
                        ...
                        if (this.lastMouseover && block.fRectIndex) {
                            var r = block.fRectIndex.getByID(
                        ...
                        if (feature) {
                            var fRect =
                                block.fRectIndex &&
                                block.fRectIndex.getByID(feature.id());
                            if (!fRect) return;

                            if (block.containsBp(bpX)) {
                                var renderTooltip = dojo.hitch(
                                    this,
                                    function () {
                                        ...
                                        if (!this.ignoreTooltipTimeout) {
                                            this.labelTooltip.style.left =
                                                evt.clientX + "px";
                                            this.labelTooltip.style.top =
                                                evt.clientY + 15 + "px";
                                        }
                                        this.ignoreTooltipTimeout = true;
                                        this.labelTooltip.style.display =
                                            "block";
                                        var labelSpan =
                                            this.labelTooltip.childNodes[0];
                                        var descriptionSpan =
                                            this.labelTooltip.childNodes[1];
                                        ...
                                        if (
                                            ...
                                            labelSpan.innerHTML = this.config
                                                .unsafeMouseover
                                                ? t
                                                : Util.escapeHTML(t);
                                            return;
                                        ...
                                        if (description) {
                                            descriptionSpan.style.display =
                                                "block";
                                            descriptionSpan.style.font =
                                                description.font;
                                            descriptionSpan.style.color =
                                                description.fill;
                                            descriptionSpan.innerHTML = this
                                                .config.unsafeMouseover
                                                ? description.text
                                                : Util.escapeHTML(
                                                      description.text,
                                                  );
            ...
            _trackMenuOptions: function () {
                ...
                this.displayModeMenuItems = displayModeList.map(
                    function (displayMode) {
                        return {
                            label: displayMode,
                            type: "dijit/CheckedMenuItem",
                            title:
                                "Render this track in " + displayMode + " mode",
                ...
                var updateMenuItems = dojo.hitch(this, function () {
                    for (var index in this.displayModeMenuItems) {
                        this.displayModeMenuItems[index].checked =
                            this.displayMode ==
                            this.displayModeMenuItems[index].label;
                    }
                });
            ...
            updateStaticElements: function (coords) {
                ...
                if (coords.hasOwnProperty("x")) {
                    ...
                    this.staticCanvas.width =
                        this.browser.view.elem.clientWidth * ratio;
                    ...
                    this.blocks.forEach((block) => {
                        ...
                        for (var id in idx) {
                            var fRect = idx[id];
                            fRect.glyph.updateStaticElements(
                                context,
                                fRect,
                                viewArgs,
                            );
