    ...
    return declare(
         ...
         */
        {
            ...
            constructor: function (args) {
                ...
                this._codonStarts =
                    this.config.codonStarts || this.defaultStarts;
            ...
            fillBlock: function (args) {
                ...
                this.heightUpdate(
                    blur.offsetHeight + 2 * blur.offsetTop,
                    blockIndex,
                );
                ...
                // suggests there are bases there if you zoom in far enough
                    ...
                    blur.innerHTML =
                        '<span class="zoom">Zoom in to see sequence</span>';
                    args.finishCallback();
                }
            },
            ...
            _renderTranslation: function (
                ...
                for (var i = 0; i < translated.length; i++) {
                    ...
                    var originalCodon = orientedSeqSliced.slice(
                        3 * i,
                        3 * i + 3,
                    );
                    ...
                    aminoAcidSpan.className =
                        "aminoAcid aminoAcid_" +
                        translated.charAt(i).toLowerCase();

                    // However, if it's known to be a start/stop, apply those CSS classes instead.
                    if (
                        this._codonStarts.indexOf(
                            originalCodon.toUpperCase(),
                        ) != -1
                    ) {
                        aminoAcidSpan.className = "aminoAcid aminoAcid_start";
                    }
                    if (
                        this._codonStops.indexOf(originalCodon.toUpperCase()) !=
                        -1
                    ) {
            ...
            _renderSeqTr: function (start, end, seq, scale) {
                ...
                if (this.config.seqType === "protein") {
                    baseClassDefault +=
                        " aaScheme_" + this.config.proteinColorScheme;
                }
             ...
             * and height.
             */
            _measureSequenceCharacterSize: function (
                containerElement,
                className,
            ) {
