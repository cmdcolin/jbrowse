define(["dojo/_base/declare", "dojo/query", "JBrowse/View/Ruler"], function (
    ...
    return declare(null, {
        ...
        makeYScale: function (args) {
            args = args || {};
            var min =
                typeof args.min == "number" ? args.min : this.minDisplayed;
            var max =
                typeof args.max == "number" ? args.max : this.maxDisplayed;
