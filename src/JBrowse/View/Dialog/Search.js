        ...
        show: function () {
            ...
            if (this.prompt) {
                ...
                on(
                    this.searchBox,
                    "change",
                    dojo.hitch(this, "searchBoxProcess"),
                );
                on(
                    this.exactCheckbox,
                    "change",
            ...
            this.locationListView = new LocationListView(
                ...
                dom.create(
                    "div",
                    {
                        ...
                        style: {
                            maxHeight:
                                0.5 * this.browser.container.offsetHeight +
                                "px",
                        },
                    },
                    container,
                            ...
                            for (var i = 0; i < res.length; i++) {
                                ...
                                if (elt.length) {
                                    ...
                                    if (elt.multipleLocations) {
                                        for (
                                            var j = 0;
                                            j < elt.multipleLocations.length;
                                            j++
                                        ) {
                                            var track = elt.multipleLocations[j]
                                                .tracks.length
