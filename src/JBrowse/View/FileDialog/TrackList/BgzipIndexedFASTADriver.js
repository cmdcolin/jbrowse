            ...
            if (resource.type == this.fileExtension) {
                ...
                for (var n in configs) {
                    ...
                    if (
                        Util.basename(
                            c[this.indexConfKey]
                                ? c[this.indexConfKey].url ||
                                      c[this.indexConfKey].blob.name
                ...
                configs[newName][this.doubleIndexConfKey] =
        ...
        finalizeConfiguration: function (configs) {
            for (var n in configs) {
                ...
                if (conf.type === this.storeType) {
                    ...
                    var v3 =
                        conf[this.doubleIndexConfKey] ||
                        conf[this.doubleIndexUrlConfKey];
                    if (!(v1 && v2 && v3)) {
                        delete configs[n];
                    }
                }
