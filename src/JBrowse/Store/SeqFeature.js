    ...
    return declare(Store, {
        ...
        _configureFeaturesTransforms: function () {
            ...
            if (typeof featureTransform === "string") {
                featureTransform =
                    this.getPredefinedFeatureTransform(featureTransform);
            }
                ...
                if (typesList.length) {
                    ...
                    this._topLevelFeaturesTransform = (features) => {
                        ...
                        features.forEach((feature) => {
                            resultFeatures.push(
                                ...this._findSubfeaturesWithTypes(
                                    typesList,
                                    feature,
                                ),
                            );
        ...
        applyFeatureTransforms: function (features) {
            ...
            this._featureTransforms.forEach((transformFunction) => {
                resultFeatures = transformFunction.call(
                    this,
                    resultFeatures,
                    this,
                );
