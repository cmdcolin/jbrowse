    ...
    var Meta = declare(
         ...
         */
        {
            ...
            constructor: function (args) {
                this.sortFacets =
                    args.sortFacets !== undefined ? args.sortFacets : true;
                ...
                args.metadataStores = dojo.filter(
                    args.metadataStores,
                    function (s) {
                        return s;
                    },
                ...
                if (!args.metadataStores || !args.metadataStores.length) {
                    ...
                    var storeFetchFinished = dojo.hitch(this, function () {
                        if (
                            ++stores_fetched_count == args.metadataStores.length
                        )
                            this._finishLoad();
                    });
                    dojo.forEach(
            ...
            _finishLoad: function () {
                ...
                dojo.forEach(
                    ...
                    function (bucket) {
                        bucket.avgBucketSize =
                            bucket.itemCount / bucket.bucketCount;
                    },
                );
                    ...
                    function (facetIndex) {
                        dojo.forEach(
                            ...
                            function (valueIndex) {
                                ...
                                valueIndex.items =
                                    uniqueItems.sort(itemSortFunction);
                            },
                            this,
                        );
                    },
            ...
            _addFacets: function (facetNames) {
                ...
                this.facets = dojo.filter(
                    ...
                    function (facetName) {
                        var take =
                            this._filterFacet(facetName) && !seen[facetName];
                        seen[facetName] = true;
                        return take;
                    },
                    this,
                    ...
                    dojo.map(
                        ...
                        function (facetName) {
                            ...
                            dojo.forEach(
                                ...
                                function (value) {
                                    var idx =
                                        this.facetIndexes.byName[facetName]
                                            .byValue[value] || {};
                                    items.push.apply(
                                        items,
                                        this._filterDeleted(idx.items || []),
                                    );
                                },
                                this,
                            );
            ...
            _countItem: function (facetMatchCounts, item, facetName) {
                ...
                var facets =
                    facetName == "__other__" ? this.facets : [facetName];
                dojo.forEach(
                    facets,
                    function (attrName) {
                        var value = this.getValue(
            ...
            _compileTextFilter: function (textString) {
                ...
                var parseWord = function () {
                    var word =
                        rQuotedWord.exec(textString) || rWord.exec(textString);
                    if (word) {
                        word = word[1];
                        var lastIndex = Math.max(
                            rQuotedWord.lastIndex,
                            rWord.lastIndex,
                        );
