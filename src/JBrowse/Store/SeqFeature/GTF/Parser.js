    ...
    return declare(null, {
            ...
            array.forEach(
                ...
                function (id) {
                    if (!this.under_construction_by_id[id]) {
                        this._buffer_feature(
                            this._create_transcript(feature_line),
                        );
                    }
                },
                this,
        ...
        _resolve_references_to: function (feature, id) {
            ...
            for (var attrname in references) {
                var pname =
                    this.container_attributes[attrname] ||
            ...
            for (var attrname in references) {
                array.forEach(
                    ...
                    function (to_id) {
                        ...
                        if (
                            (other_feature =
                                this.under_construction_by_id[to_id])
                        ) {
                            ...
                            (this.under_construction_orphans[to_id][attrname] =
                                this.under_construction_orphans[to_id][
                                    attrname
                                ] || []).push(feature);
                        }
                    },
