    ...
    return declare(SeqFeatureStore, {
        ...
        _handleTrackInfo: function (refData, trackInfo, url) {
            refData.stats = {
                ...
                featureDensity:
                    (trackInfo.featureCount || 0) / this.refSeq.length,
            };
        ...
        getGlobalStats: function (successCallback, errorCallback) {
            return (
                this._deferred.root ||
                this.getDataRoot(this.browser.refSeq.name)
            ).then(function (data) {
            ...
            this.getDataRoot(query.ref)
                .then(function (data) {
                    ...
                    if (query.numBins) {
                        ...
                        numBins = Math.ceil(
                            (query.end - query.start) / basesPerBin,
                        );
                    } else {
                        throw new Error(
                    ...
                    var binRatio =
                        basesPerBin / ((histogramMeta || {}).basesPerBin || 1);
                    ...
                    if (
                        ...
                        histogramMeta.lazyArray.range(
                            ...
                            function (i, val) {
                                ...
                                histogram[
                                    Math.floor((i - firstServerBin) / binRatio)
                                ] += val;
                            },
                            function () {
                                successCallback({
