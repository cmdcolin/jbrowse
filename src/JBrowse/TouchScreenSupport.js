define([], function () {
    ...
    Touch = {
        ...
        touchSimulated: function (event) {
            if (event.touches.length <= 1) {
                var touches = event.changedTouches,
                    ...
                    type2 = "mouseover",
                    objAvatar =
                        document.getElementsByClassName("dojoDndAvatar"),
                    obj = {},
        ...
        touchHandle: function (event) {
            dojo.query(".dojoDndItemAnchor").connect(
                "touchstart",
                Touch.touchSimulated,
            );
            dojo.query(".dojoDndItemAnchor").connect(
                "touchmove",
                Touch.touchSimulated,
        ...
        touchinit: function () {
            dojo.query(".dojoDndItem").connect(
                "touchstart",
                Touch.touchSimulated,
            );
            dojo.query(".dojoDndItem").connect(
            ...
            dojo.query(".locationThumb").connect(
                "touchstart",
                Touch.touchHandle,
            );
            dojo.query(".locationThumb").connect(
            ...
            dojo.query(".dojoDndTarget").connect(
                "touchstart",
                Touch.touchHandle,
            );
            dojo.query(".dojoDndTarget").connect(
            ...
            dojo.query(".dijitSplitter").connect(
                "touchstart",
                Touch.touchHandle,
            );
            dojo.query(".dijitSplitter").connect(
