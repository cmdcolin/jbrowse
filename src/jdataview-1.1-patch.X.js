...
(function (global) {
    ...
    var jDataView = function (buffer, byteOffset, byteLength, littleEndian) {
        if (!(this instanceof jDataView)) {
            throw new Error(
                "jDataView constructor may not be called as a function",
            );
        }
        ...
        var bufferLength = this._isArrayBuffer
            ? buffer.byteLength
            : buffer.length;
                ...
                (function (type, view) {
                    ...
                    view["get" + type] = function (byteOffset, littleEndian) {
                        ...
                        if (
                            ...
                            if (typeof byteOffset !== "number") {
                                throw new TypeError(
                                    "jDataView byteOffset is not a number",
                                );
                            }
            ...
            responseHandler: {
                dataview: function (responses, options, xhr) {
                    ...
                    // Internet Explorer (Byte array accessible through VBScript -- convert to text)
                        ...
                        responses.text = convertResponseBodyToText(
                            xhr.responseBody,
                        );
                    }
                    // Older Browsers
