        ...
        return (
            <div>
                <Container className="mainContainer documentContainer postContainer">
                    ...
                    <p>
                        The course of JBrowse development is set by the GitHub
                        issues and the release milestones they are assigned to.
                    </p>
                    <p>
                        View the{" "}
                        <a
                        ...
                        page to explore what new features are planned for each
                        release.
                    </p>
                    ...
                    <p>
                        ...
                        . Permission to use this trademark should be solicited
                        by email to <em>ihholmes at gmail dot com</em> and will
                        typically be granted for activities that do not
                        compromise the role of the ESF as primary custodians of
                        the JBrowse software and name. (For example, mentioning
                        that your company offers JBrowse customization or
                        consultancy will almost certainly be OK; selling a
                        software package as "JBrowse Plus", or similar, may be
                        problematic.)
                    </p>
