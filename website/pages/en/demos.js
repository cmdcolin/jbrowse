            ...
            <Container className="mainContainer documentContainer postContainer">
                ...
                <ul>
                    <li>
                        ...
                         - the latest JBrowse release, showing the primary test
                        data set used in development.  Includes demonstrations
                        of all major JBrowse track types, including direct
                        display of BAM alignments and coverage, direct display
                        of BigWig data, and more.  This data is made up for
                    ...
                    <li>
                        ...
                         - running in the latest JBrowse release with over 1,800
                        tracks.  Based on a snapshot of the modENCODE track
                        metadata taken from 
                        <a href="http://data.modencode.org" target="_blank">
                            http://data.modencode.org
                        </a>
                        .  Note that the actual track data and reference
                        sequences in this track selection demo are just made-up
                        test data.
                    </li>
                    <li>
                        <a
                        ...
                        - a demonstration of a large dataset.  From UCSC Genome
                        Database - 
                    ...
                    <li>
                        ...
                        - from FlyBase release 5.52.  Good demonstration of
                        JBrowse 1.12.0 canvas-based gene glyphs.
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        ...
                        - running in JBrowse 1.5.0, including a BigWig track
                        showing RNA-Seq coverage
                    </li>
                    <li>
                        <em>
