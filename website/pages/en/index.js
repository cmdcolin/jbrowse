...
const FeatureCallout = (props) => (
    <div className="paddingBottom" style={{ textAlign: "left" }}>
        ...
        <ul>
            ...
            <li>
                Scales easily to multi-gigabase genomes and deep-coverage
                sequencing.
            </li>
            <li>
                Quickly open and view data files on your computer without
                uploading them to any server.
            </li>
            <li>
                Supports GFF3, BED, FASTA, Wiggle, BigWig, BAM, CRAM, VCF (with
                either .tbi or .idx index), REST, and more. BAM, BigBed, BigWig,
                and VCF data are displayed directly from chunks of the
                compressed binary files, no conversion needed.
            </li>
            <li>
            ...
            <li>
                ...
                back-end server code, it just reads chunks of files directly
                over HTTP using{" "}
                <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Range_requests">
                    byte-range requests
                </a>
                . You can serve huge datasets from a single low-cost cloud
                instance.
            </li>
            <li>
                JBrowse Desktop runs as a stand-alone app on Windows, Mac OS,
                and Linux.
            </li>
            <li>
...
const BrowserCompat = (props) => (
    <div className="paddingBottom" style={{ textAlign: "left" }}>
        ...
        <p>
            The latest release of JBrowse is tested to work with the following
            web browsers:
        </p>
        <ul>
        ...
        <p>
            Server-side code, which is used only to pre-generate static data
            files (no CGI), requires only BioPerl and a few other CPAN modules.
            The result is a cross-platform AJAX genome browser that is easy to
            install, embed and customize.
        </p>
        <p>
...
const ExtraInfo = (props) => (
    <div className="paddingBottom" style={{ textAlign: "left" }}>
        ...
        <p>
            If you use JBrowse in a project that you publish, please cite the
            most recent JBrowse paper listed on the{" "}
...
const HeaderInfo = (props) => (
    <div className="paddingBottom" style={{ textAlign: "left" }}>
        ...
        <p>
            ...
            JavaScript and HTML5. It can run on your desktop, or be embedded in
            your website.
        </p>
